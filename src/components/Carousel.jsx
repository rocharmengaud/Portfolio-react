  ...
  return (
    <>
      <div className="sm:max-w-[600px] max-w-[300px] sm:h-[600px] h-[400px] w-full relative mx-auto flex flex-col justify-center items-center">
        ...
        <div className="absolute top-[50%] left-0 sm:left-2 rounded-full sm:p-2 p-1 bg-black/10 text-white cursor-pointer hover:opacity-80">
          <BsChevronCompactLeft size={30} onClick={prevSlide} />
        </div>
        <div className="absolute top-[50%] right-0 sm:right-2 rounded-full sm:p-2 p-1 bg-black/10 text-white cursor-pointer hover:opacity-80">
